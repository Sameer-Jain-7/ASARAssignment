...
class SwipeButtonView: UIButton {
    ...
    @IBInspectable var InitialStateColor: UIColor? = UIColor(red: 239.0/255.0, green: 0/255.0, blue: 0/255.0, alpha: 1.0) {
        didSet {
    ...
    func setSwipableLayer() -> UIView {
        ...
        swipableView?.backgroundColor = UIColor.black
